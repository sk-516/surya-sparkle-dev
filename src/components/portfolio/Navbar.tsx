      ...
      <div className={`mx-auto max-w-6xl px-4 ${scrolled ? "" : ""}`}>
        <div className={`flex items-center justify-between rounded-2xl px-4 py-3 ${scrolled ? "glass-strong shadow-card" : "glass"}`}>
          <a href="#home" className="flex items-center gap-2 font-display text-lg font-bold">
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-[image:var(--gradient-hero)] text-primary-foreground shadow-neon">S</span>
          ...
          <a href="#contact" className="hidden rounded-xl bg-[image:var(--gradient-hero)] px-4 py-2 text-sm font-semibold text-primary-foreground shadow-neon transition hover:opacity-90 md:inline-block">
            Hire Me
          </a>
          <button onClick={() => setOpen(v => !v)} className="rounded-lg p-2 text-foreground md:hidden" aria-label="Menu">
